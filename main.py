...
def parse_args():
  ...
  parser.add_argument(
        '--wandb_project', type=str, default='MultiAgent-Experiments',
...
def main(args):
    device, config, env, metacontroller_class = initialize(
      args.mode, args.env_name, args.debug, args.visualize, args.seed, args.wandb_project)
    ...
    if not args.debug and not args.visualize:  # Real run that logs to wandb
      ...
      current_wandb_projects = ['MultiAgent-Experiments']  # Add your wandb project here
